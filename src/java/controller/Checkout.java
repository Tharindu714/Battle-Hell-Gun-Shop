...
public class Checkout extends HttpServlet {
    ...
    private void saveOrders(Session session, Transaction transaction, User user, Address address, JsonObject responseJsonObject) {
        try {
            //create order in DB
            entity.Purchase order = new entity.Purchase();
            ...
            Purchase_Status order_Status = (Purchase_Status) session.get(Purchase_Status.class, 1);
            ...
            for (Cart cartItem : cartList) {
                ...
                Purchase_items order_item = new Purchase_items();
